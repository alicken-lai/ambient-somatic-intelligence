...
description: >
  Advisory behavioral guidelines (mirrored) to reduce common LLM coding mistakes.
  Hermes Constitution and Guardian supersede this skill. Not sovereign truth.
license: MIT
provenance:
  source_url: https://github.com/multica-ai/andrej-karpathy-skills
  source_path: skills/karpathy-guidelines/SKILL.md
  mirrored_at: "2026-05-19"
  advisory_only: true
---

# Karpathy Guidelines (Hermes Advisory Mount)

> **Advisory only — Hermes Constitution supersedes.**  
> Mirrored from [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills).  

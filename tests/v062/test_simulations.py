"""Area 8 stress: v062 simulation windows."""

from pathlib import Path

from v062_runtime.simulations import WINDOWS, run_all_windows, write_timeseries
...
def test_run_all_windows_gate() -> None:
    ...
    for w in data["windows"].values():
        assert w["identity_score"] >= 0.85


def test_write_timeseries(tmp_path: Path) -> None:
    out = tmp_path / "provenance_timeseries.json"

"""Area 9–10: CognitiveCivilizationStabilityScore gate."""
...
def test_clean_evidence_passes() -> None:
    ...
    report = evaluate_cognitive_civilization_stability(ev)
    assert report.civilization_score >= 0.90
    assert report.gate_pass is True

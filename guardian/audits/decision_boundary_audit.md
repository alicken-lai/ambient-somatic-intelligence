...
- RECOMMEND_ONLY: `telemetry-local`, `incident-recall-build`, `baseline-learn-build`, `health-score-build`, `memory-pressure-diagnose`, `circadian-baseline-build`, `system-state-build`, `somatic-dashboard-build`, `daily-digest-build`, `anomaly-explain-build`, `memory-integrity-audit`, `self-reflect-build`, `operator-briefing-build`
